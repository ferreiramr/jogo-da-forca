...
def index():
    ...
    if jogo.infelizmente_saiu_vivo():
        ...
        return render_template('index.html', forca=jogo.desenho_da_forca(), palavra_secreta=jogo.palavra_secreta(), chutes=jogo.chutes(), formulario_de_chute=formulario_de_chute)
